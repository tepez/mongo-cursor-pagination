...
module.exports = {
  ...
  prepareResponse(results, params) {
    ...
    if (response.previous) {
      const previousPaginatedField = dopProp.get(response.previous, params.paginatedField);
    ...
    if (response.next) {
      const nextPaginatedField = dopProp.get(response.next, params.paginatedField);
      if (shouldSecondarySortOnId) {
